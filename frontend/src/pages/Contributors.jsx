    ...
    <div className="min-h-screen py-16 px-6" style={{ backgroundColor: theme.colors.bgLight }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-[11px] font-bold tracking-[0.2em] uppercase mb-3" style={{ color: theme.colors.secondary }}>
            The Team
          </p>
          ...
          <p className="mt-4 text-sm md:text-lg font-medium" style={{ color: theme.colors.textMuted }}>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="relative shrink-0 mx-auto md:mx-0">
                  <div className="w-28 h-28 rounded-2xl overflow-hidden border-2" style={{ borderColor: theme.colors.border }}>
                ...
                <div className="flex-1 w-full">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold" style={{ color: theme.colors.textMain }}>{member.name}</h3>
                    <div className="flex gap-4">
                      <a href={member.socials.github} target="_blank" rel="noreferrer" className="opacity-40 hover:opacity-100 transition-opacity" style={{ color: theme.colors.textMain }}><Github size={18} /></a>
                      <a href={member.socials.linkedin} target="_blank" rel="noreferrer" className="opacity-40 hover:opacity-100 transition-opacity" style={{ color: theme.colors.primary }}><Linkedin size={18} /></a>
                      <a href={member.socials.instagram} target="_blank" rel="noreferrer" className="opacity-40 hover:opacity-100 transition-opacity" style={{ color: theme.colors.secondary }}><Instagram size={18} /></a>
                    </div>
                  </div>

                  <p className="font-bold text-[11px] uppercase tracking-wider mb-4 flex items-center gap-2" style={{ color: theme.colors.primary }}>
                  ...
                  <div className="space-y-3 p-5 rounded-2xl border" style={{ backgroundColor: theme.colors.bgLight, borderColor: theme.colors.border }}>
                    <h4 className="text-[9px] font-bold uppercase tracking-widest flex items-center gap-2 opacity-60" style={{ color: theme.colors.textMain }}>
                        <GraduationCap size={14} /> Academic Background
                    </h4>
                    {member.education.map((edu, idx) => (
                      <div key={idx} className="flex flex-col">
                        <span className="text-xs font-bold" style={{ color: theme.colors.textMain }}>{edu.degree}</span>
                        <span className="text-[10px] font-medium" style={{ color: theme.colors.textMuted }}>{edu.institute}</span>
                      </div>
                    ))}
                  </div>
                </div>
